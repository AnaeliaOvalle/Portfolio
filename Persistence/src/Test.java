...
public class Test {
	...
	public static void testNamesBST()
	{
		...
		System.out.println("Creating persistent tree using key: "+keys[j]);
		...
		for (int i = 0; i <= t.currentTime(); i++) {
			System.out.println("******Tree at time: "+i+"******");
			System.out.println("Found: "+t.find("{ \"first\" : \"David\" , \"last\" : \"Smith\"}", i));
	...
	public static void testStack()
	{
		...
		System.out.println("Creating new persistent stack");
		S.push("A");
		S.push("B");
		S.push("C");
		S.push("D");
	...
	public static void testAbstractBST()
	{
		...
		{
			PersistentBST t = new PersistentBST(keys[j]);
			System.out.println("Creating persistent abstract tree using key: "+keys[j]);
